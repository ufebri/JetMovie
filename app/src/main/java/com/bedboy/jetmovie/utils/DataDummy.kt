...
object DataDummy {
    ...
    fun generateVideo(): List<VideoEntity> =
        arrayListOf(
            VideoEntity("nSbzyEJ8X9E"),
            VideoEntity("w7pYhpJaJW8"),
            VideoEntity("297802"),
            VideoEntity("mP0VHJYFOAU"),
            VideoEntity("0phuNQQ_gHI"),
            VideoEntity("nSbzyEJ8X9E"),
            VideoEntity("w7pYhpJaJW8"),
            VideoEntity("297802"),
            VideoEntity("mP0VHJYFOAU"),
            VideoEntity("0phuNQQ_gHI"),
            VideoEntity("bjqEWgDVPe0"),
            VideoEntity("ga0iTWXCGa0"),
            VideoEntity("3g2yTcg1QFI"),
            VideoEntity("XgUmyAGwxgw"),
            VideoEntity("SqILm2JuHx4"),
            VideoEntity("bjqEWgDVPe0"),
            VideoEntity("ga0iTWXCGa0"),
            VideoEntity("3g2yTcg1QFI"),
            VideoEntity("XgUmyAGwxgw"),
