package id.daydream.jetmovie.data.source.remote

import android.util.Log
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import id.daydream.jetmovie.data.source.remote.response.DataGenre
import id.daydream.jetmovie.data.source.remote.response.DataResponse
import id.daydream.jetmovie.data.source.remote.response.GetDetailVideos
import id.daydream.jetmovie.data.source.remote.response.ResultsGenre
import id.daydream.jetmovie.data.source.remote.response.ResultsItem
import id.daydream.jetmovie.data.source.remote.response.ResultsVideos
import id.daydream.jetmovie.utils.EspressoIdlingResource
...
class RemoteDataSource {
    ...
    companion object {
        private val client = id.daydream.jetmovie.network.ApiConfig.getApiService()
